...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"100px","bottom":"100px"}}},"backgroundColor":"black","layout":{"wideSize":"1170px","contentSize":"1170px"}} -->
		...
		<div class="wp-block-column"><!-- wp:group -->
			...
			<div class="wp-block-group" style="padding-top:40px"><!-- wp:columns -->
				<div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"bottom"} -->
					<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:cover {"url":"<?php echo get_template_directory_uri(); ?>/assets/img/employee-meeting-work-job-working-argentina-1599048-pxhere.com.webp","id":112,"dimRatio":30,"customOverlayColor":"#050505","minHeight":580,"minHeightUnit":"px","isDark":false,"style":{"spacing":{"padding":{"left":"20px"}}}} -->
						<div class="wp-block-cover is-light" style="padding-left:20px;min-height:580px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim" style="background-color:#050505"></span><img class="wp-block-cover__image-background wp-image-112" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/employee-meeting-work-job-working-argentina-1599048-pxhere.com.webp" data-object-fit="cover" />
							<div class="wp-block-cover__inner-container"><!-- wp:spacer {"height":"480px"} -->
					...
					<div class="wp-block-column"><!-- wp:group -->
						<div class="wp-block-group"><!-- wp:columns -->
							<div class="wp-block-columns"><!-- wp:column -->
								<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo get_template_directory_uri(); ?>/assets/img/employee-meeting-work-job-working-argentina-1599057-pxhere.com.webp","id":113,"dimRatio":30,"minHeight":280,"isDark":false} -->
									<div class="wp-block-cover is-light" style="min-height:280px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-113" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/employee-meeting-work-job-working-argentina-1599057-pxhere.com.webp" data-object-fit="cover" />
										<div class="wp-block-cover__inner-container"><!-- wp:spacer {"height":"140px"} -->
						...
						<div class="wp-block-group" style="padding-top:20px"><!-- wp:columns -->
							<div class="wp-block-columns"><!-- wp:column -->
								<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo get_template_directory_uri(); ?>/assets/img/computer-group-building-home-internet-office-945774-pxhere.com.webp","id":111,"dimRatio":30,"minHeight":280,"isDark":false} -->
									<div class="wp-block-cover is-light" style="min-height:280px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-111" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/computer-group-building-home-internet-office-945774-pxhere.com.webp" data-object-fit="cover" />
										<div class="wp-block-cover__inner-container"><!-- wp:spacer {"height":"140px"} -->
											<div style="height:140px" aria-hidden="true" class="wp-block-spacer"></div>
											<!-- /wp:spacer -->
