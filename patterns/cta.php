...
<!-- wp:cover {"url":"<?php echo get_template_directory_uri(); ?>/assets/img/laptop-notebook-computer-smartphone-mobile-writing-764384-pxhere.com.webp","id":49,"dimRatio":90,"overlayColor":"black"} -->
<div class="wp-block-cover"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-90 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-49" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/laptop-notebook-computer-smartphone-mobile-writing-764384-pxhere.com.webp" data-object-fit="cover" />
	<div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"100px","bottom":"100px"}}},"layout":{"wideSize":"1170px"}} -->
		<div class="wp-block-group" style="padding-top:100px;padding-bottom:100px"><!-- wp:columns -->
			<div class="wp-block-columns"><!-- wp:column -->
				<div class="wp-block-column"><!-- wp:social-links {"size":"has-normal-icon-size","align":"center","className":"is-style-iconsborderhover zeever-animate zeever-move-down zeever-delay-1","layout":{"type":"flex","justifyContent":"center","flexWrap":"wrap","orientation":"horizontal"}} -->
					...
					<h2 class="has-text-align-center zeever-animate zeever-move-up zeever-delay-1 has-white-color has-text-color has-heading-2-font-size" style="margin-top:40px;margin-bottom:40px">Hai qualche progetto in mente?</h2>
					<!-- /wp:heading -->
