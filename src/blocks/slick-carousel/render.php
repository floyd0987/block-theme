...
<div <?php echo get_block_wrapper_attributes(); ?>>
	...
	<div class="carousel center">
		<?php foreach ($selected_posts as $post_id) :
			...
			$image_url = get_the_post_thumbnail_url($post_id, 'medium_large'); // Get featured image URL
			$post_title = esc_html($post->post_title); // Escape the post title
			$post_link = esc_url(get_permalink($post_id)); // Get the post link
		?>
